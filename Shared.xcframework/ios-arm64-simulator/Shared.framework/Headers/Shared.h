...
@class SharedJokeResponse, SharedJokeResponseCompanion, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinIllegalStateException, SharedKotlinNothing, SharedKotlinRuntimeException, SharedKotlinThrowable, SharedKotlinx_serialization_coreSerialKind, SharedKotlinx_serialization_coreSerializersModule;
...
- (int32_t)addA:(int32_t)a b:(int32_t)b __attribute__((swift_name("add(a:b:)")));
- (double)divideA:(int32_t)a b:(int32_t)b __attribute__((swift_name("divide(a:b:)")));
- (int32_t)multiplyA:(int32_t)a b:(int32_t)b __attribute__((swift_name("multiply(a:b:)")));
- (int32_t)subtractA:(int32_t)a b:(int32_t)b __attribute__((swift_name("subtract(a:b:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ChuckNorrisClient")))
@interface SharedChuckNorrisClient : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
*/
- (void)getJokeWithCompletionHandler:(void (^)(NSString * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getJoke(completionHandler:)")));
@end
...
@interface SharedJokeApi : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)fetchJokeCallback:(void (^)(NSString *))callback __attribute__((swift_name("fetchJoke(callback:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("JokeResponse")))
@interface SharedJokeResponse : SharedBase
- (instancetype)initWithValue:(NSString *)value __attribute__((swift_name("init(value:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedJokeResponseCompanion *companion __attribute__((swift_name("companion")));
- (SharedJokeResponse *)doCopyValue:(NSString *)value __attribute__((swift_name("doCopy(value:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("JokeResponse.Companion")))
@interface SharedJokeResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedJokeResponseCompanion *shared __attribute__((swift_name("shared")));
